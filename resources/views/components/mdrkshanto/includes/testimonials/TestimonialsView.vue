        ...
        <div class="owl-carousel testimonial-carousel">
            <div class="text-left">
                ...
                <div class="d-flex align-items-center">
                    <img class="img-fluid" src="/mdrkshanto/assets/img/testimonial-1.jpg"
            ...
            <div class="text-left">
                ...
                <p class="fs-4 mb-4">Dolor eirmod diam stet kasd sed. Aliqu rebum est eos. Rebum elitr
                    ...
                    eirmod eos, labore diam clita</p>
                <div class="d-flex align-items-center">
                    <img class="img-fluid" src="/mdrkshanto/assets/img/testimonial-2.jpg"
                         style="width: 60px; height: 60px;">
                    <div class="ps-3">
                        <p class="text-primary fs-5 mb-1">Client Name</p>
                        <i>Profession</i>
            ...
            <div class="text-left">
                ...
                <p class="fs-4 mb-4">Dolor eirmod diam stet kasd sed. Aliqu rebum est eos. Rebum elitr
                    ...
                    eirmod eos, labore diam clita</p>
                <div class="d-flex align-items-center">
                    <img class="img-fluid" src="/mdrkshanto/assets/img/testimonial-3.jpg"
                         style="width: 60px; height: 60px;">
                    <div class="ps-3">
                        <p class="text-primary fs-5 mb-1">Client Name</p>
                        <i>Profession</i>
